/*
    ...
    Extracts builtin identifiers from TypeScript's library definitions.
    Used by client to create the "squeeze-builtins" array.
*/
...
_visitNode(node)
{
    ...
    if (ts.isIdentifier(node)) {
        ...
        ts.isParameter(node) ||
        ts.isPartOfParameterDeclaration(node) ||
