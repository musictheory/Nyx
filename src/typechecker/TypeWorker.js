...
// When true, TypeScript is not actually loaded. This allows us to test
// code generation and threading
let sIsFastTestEnabled = false;
...
async function typecheck(checkerID, entries, filesToCheck)
{
    ...
    if (service === "dev-fast-test") return [ ];
